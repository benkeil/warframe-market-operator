...
import (
	...
	"github.com/benkeil/warframe-market-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(warframemarketv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "104d70e2.warframe.market",
